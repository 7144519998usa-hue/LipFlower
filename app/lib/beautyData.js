        ...
        links: [
          {
            href: "/skin-care",
            label: "Skin care",
            description: "Explore serums, moisturizers, eye creams, cleansers, SPF, and treatment-led luxury routines.",
          },
          {
            href: "/makeup",
            label: "Makeup",
          ...
          },
          {
            href: "/lip-care",
            label: "Lip care",
            description: "Find premium balms, masks, plumpers, oils, liners, gloss, and lipstick-led guides.",
          },
          {
            href: "/fragrance",
            label: "Fragrance",
            description: "Browse signature scents, discovery sets, gifting options, and luxury fragrance houses.",
          },
          {
            href: "/hair-care",
            label: "Hair care",
            description: "Explore shampoos, conditioners, masks, stylers, scalp care, and salon-grade routines.",
          },
          {
            href: "/body-care",
            label: "Body care",
          ...
          },
          {
            href: "/beauty-tools",
            label: "Beauty tools",
            description: "Explore brushes, facial tools, hair tools, storage, and routine-support accessories.",
          },
          {
            href: "/artificial-jewelry",
            label: "Artificial jewelry",
            description: "Explore fashion jewelry, occasion accessories, giftable sets, and retailer details before styling a beauty look.",
          },
        ],
      },
      {
        ...
        links: [
          {
            ...
            description: "A curated edit for prestige shoppers who want top-tier brands and giftable products.",
          },
          {
            href: "/compare",
            label: "Beauty comparisons",
            description: "Use head-to-head pages before choosing between brands, routines, textures, and retailers.",
          },
          {
            href: "/brands",
            label: "Brand directory",
            description: "Move from designer and prestige brand research into category-specific shopping guides.",
          },
          {
            href: "/sellers",
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            description: "Find richer creams and moisturizers by skin feel, finish, and where they fit in a routine.",
          },
          {
            href: "/skin-care/vitamin-c-serums",
            label: "Vitamin C serums",
            description: "Evaluate radiance-focused serums with careful ingredient-claim context.",
          },
          {
          ...
          },
          {
            ...
            label: "Cream blush",
            description: "Choose cream blush by finish, pigment, shade family, and retailer details.",
          },
          {
            href: "/lip-care/lip-masks",
            label: "Lip masks",
            description: "See how overnight lip treatments, balm masks, and glossy treatment formats differ.",
          },
          {
            href: "/lip-care/lip-oils",
            label: "Lip oils",
            description: "Sort lip oils by shine, tint, applicator, fragrance, and comfort-focused positioning.",
          },
          {
            href: "/beauty-university",
            label: "Beauty University",
            description: "Read buyer-first guides that support premium beauty decisions before shopping.",
          },
        ],
      },
    ],
...
export const beautyLandingPages = [
  {
    ...
    watchFor: ["Ingredient sensitivity", "Authenticity and retailer details"],
  ...
  },
  {
    ...
    summary: "A guide to richer moisturizers for comfort, texture, dry-feeling skin, and dependable routine use.",
    intro:
  ...
  },
  {
    ...
    summary: "A careful look at prestige vitamin C serums by texture, packaging, routine fit, and retailer details.",
    intro:
  ...
  },
  {
    ...
    summary: "Find elevated SPF formulas by finish, layering feel, tint, and makeup compatibility.",
    intro:
  ...
  },
  {
    ...
    summary: "Choose prestige foundation by finish, coverage, shade range, and retailer fit.",
    intro:
      "High-end foundation is a fit decision as much as a brand decision, so this guide keeps finish, coverage, undertone, and return-friendly retailers in view.",
    bestFor: ["Designer complexion products", "Polished everyday makeup", "Event-ready coverage"],
    watchFor: ["Shade matching", "Return policy and retailer reliability"],
  ...
  },
  {
    ...
    summary: "A luxury cream blush guide for finish, pigment, skin prep, packaging, and retailer fit.",
    intro:
  ...
  },
  {
    ...
    summary: "Find high-end concealer by coverage, finish, undertone, wear expectations, and retailer clarity.",
    intro:
  ...
  },
  {
    ...
    summary: "A prestige setting powder guide for finish, soft-focus positioning, skin tone support, and makeup style.",
    intro:
  ...
  },
  {
    ...
    summary: "A shopper-friendly look at overnight masks, balm treatments, and glossy lip treatment products.",
    intro:
  ...
  },
  {
    ...
    summary: "Find premium lip oils by shine, tint, texture, applicator, and retailer fit.",
    intro:
      "Lip oil shoppers often want treatment feel and gloss-like shine in one product, so this guide keeps texture, tint, and fragrance preferences visible.",
  ...
  },
  {
    ...
    summary: "A tinted balm guide for color payoff, comfort, finish, and daily-carry appeal.",
    intro:
  ...
  },
  {
    ...
    summary: "A careful lip plumper guide for finish, sensation level, shine, and realistic expectations.",
    intro:
  ...
  },
  {
    ...
    summary: "Find premium shampoo and conditioner by hair type, fragrance, finish, and retailer details.",
    intro:
  ...
  },
  {
    ...
    summary: "A premium hair mask guide for texture, use frequency, hair-feel goals, and treatment intensity.",
    intro:
  ...
  },
  {
    ...
    summary: "A scalp-care shopping guide by format, routine step, fragrance, and comfort positioning.",
    intro:
  ...
  },
  {
    ...
    summary: "Shop discovery sets by scent family, sample count, redemption value, and gifting flexibility.",
    intro:
  ...
  },
  {
    ...
    summary: "A premium fragrance gifting guide by bottle size, scent family, packaging, and retailer flexibility.",
    intro:
      "Perfume gifting works best when the guide considers presentation, scent familiarity, discovery alternatives, and retailer flexibility rather than pushing one universal fragrance.",
  ...
  },
  {
    ...
    summary: "Find luxury fragrances by scent family, occasion, bottle size, and buyer confidence.",
    intro:
      "A signature scent is personal, so LipFlower frames fragrance discovery around scent family, wear occasion, retailer clarity, and sampling options before a full-size purchase.",
  ...
  },
  {
    ...
    summary: "A body moisturizer guide for texture, fragrance, finish, and routine fit.",
    intro:
  ...
  },
  {
    ...
    summary: "A careful body exfoliant guide by format, texture, fragrance, and use guidance.",
    intro:
      "Body exfoliant guides need careful language around texture, use frequency, and product directions, especially for shoppers with sensitivity history.",
  ...
  },
  {
    ...
    summary: "Find premium hand creams, cuticle-adjacent routines, fragrance, and giftable hand-care sets.",
    intro:
      "Hand-care shopping blends body care and gifting, so this guide keeps texture, scent, portability, packaging, and retailer confidence in view.",
  ...
  },
  {
    ...
    summary: "A luxury nail polish guide by finish, shade family, wear expectations, and retailer clarity.",
    intro:
  ...
  },
  {
    ...
    summary: "A cuticle-care guide for oils, creams, hand-care pairings, texture, scent, and routine fit.",
    intro:
  ...
  },
  {
    ...
    summary: "Find premium manicure tools by material, ergonomics, care needs, and at-home routine support.",
    intro:
      "Manicure tools are a quality and handling decision, so shoppers should compare materials, tool care, storage, and retailer reliability before continuing.",
  ...
  },
  {
    ...
    summary: "A premium makeup brush guide by shape, material, use case, storage, and retailer clarity.",
    intro:
  ...
  },
  {
    ...
    summary: "A careful facial-tool guide by routine fit, material, care instructions, and product language.",
    intro:
  ...
  },
  {
    ...
    summary: "Find premium hair tools by styling goal, heat settings, attachment set, and retailer clarity.",
    intro:
      "Hair styling tools should be compared by hair type, heat options, attachments, warranty context, and retailer clarity rather than trend-led claims alone.",
  ...
  },
  {
    ...
    summary: "A guide to artificial earrings by finish, metal tone, closure style, occasion, and retailer clarity.",
    intro:
      "Artificial earrings are a styling decision, so shoppers should compare metal tone, weight, closure type, occasion fit, and retailer details before treating a pair as a wardrobe staple.",
  ...
  },
  {
    ...
    summary: "A guide to artificial necklaces by chain length, plating tone, pendant style, layering potential, and retailer details.",
    intro:
      "Fashion necklaces can complete a beauty look, but shoppers should compare chain length, plating description, clasp style, and return flexibility before continuing.",
  ...
  },
  {
    ...
    summary: "A guide to artificial bracelets by fit, finish, clasp style, stacking appeal, and retailer clarity.",
    intro:
  ...
  },
  {
    ...
    summary: "A guide to artificial jewelry sets by packaging, style coordination, occasion, and return-friendly retailers.",
    intro:
      "Artificial jewelry gift sets should be compared by presentation, metal tone, style versatility, and retailer clarity rather than assuming every set fits every recipient.",
...
export const beautyComparePages = [
  ...
  },
  {
    ...
    summary: "Compare two popular ingredient-led serums without overstating outcomes.",
    verdict:
  ...
  {
    slug: "cleanser-vs-cleansing-balm",
    title: "Cleanser vs Cleansing Balm",
    summary: "Compare daily facial cleansers with richer first-cleanse balms before building a skin-care routine.",
    verdict:
      "A cleanser is usually the better daily anchor, while a cleansing balm is stronger when makeup, sunscreen, or richer textures need a first-cleanse step.",
    columns: ["Daily cleanser", "Cleansing balm"],
    rows: [
      { label: "Best role", values: ["Everyday cleanse", "First cleanse or makeup removal"] },
      { label: "Texture", values: ["Gel, cream, or foam", "Balm-to-oil or rich melt"] },
      { label: "Buyer mindset", values: ["Simple routine anchor", "Double-cleanse upgrade"] },
      { label: "Shopping note", values: ["Check skin feel after rinsing", "Check residue and eye-area directions"] },
    ],
    relatedLinks: ["/skin-care", "/best/best-cleanser", "/beauty-university/beauty-routine-order-chart"],
  },
  {
    slug: "retinol-serum-vs-peptide-serum",
    title: "Retinol Serum vs Peptide Serum",
    summary: "Compare two mature-routine serum options with careful shopping context.",
    verdict:
    ...
    relatedLinks: ["/best/best-retinol-serum", "/skin-care/anti-aging-serums", "/beauty-university/ingredient-compatibility-cheat-sheet"],
  },
  {
    slug: "moisturizer-vs-barrier-cream",
    title: "Moisturizer vs Barrier Cream",
    summary: "Decide whether a general moisturizer or richer barrier-positioned cream fits the routine better.",
    verdict:
      "A moisturizer is the flexible daily staple, while a barrier cream is usually better for shoppers who want a richer comfort-focused texture and a more cushioned routine anchor.",
    columns: ["Moisturizer", "Barrier cream"],
    rows: [
      { label: "Best role", values: ["Daily hydration step", "Rich comfort step"] },
      { label: "Texture", values: ["Gel, lotion, cream, or balm", "Usually creamier or more occlusive"] },
      { label: "Routine timing", values: ["Morning or evening", "Often evening or dry-feeling routines"] },
      { label: "Shopping note", values: ["Match finish to skin feel", "Check fragrance and heaviness"] },
    ],
    relatedLinks: ["/skin-care/barrier-repair-moisturizers", "/best/best-barrier-cream", "/skin-care"],
  },
  {
    slug: "sunscreen-vs-primer",
    title: "Sunscreen vs Primer",
    summary: "Compare SPF and makeup-prep products without blurring protection, finish, and cosmetic roles.",
    verdict:
      "Sunscreen is the protection step when used as directed, while primer is the cosmetic prep step for texture, grip, and finish before makeup.",
    columns: ["Sunscreen", "Primer"],
    rows: [
      { label: "Primary role", values: ["SPF protection step", "Makeup-prep step"] },
      { label: "Finish concern", values: ["White cast, tint, shine, or matte feel", "Grip, blur, glow, or smoothing"] },
      { label: "Layering", values: ["Usually before makeup", "Usually after skin care and before foundation"] },
      { label: "Shopping note", values: ["Follow SPF directions", "Check compatibility with foundation"] },
    ],
    relatedLinks: ["/skin-care/sunscreen-for-makeup-prep", "/makeup", "/beauty-university/beauty-routine-order-chart"],
  },
  {
    ...
    rows: [
      { label: "Coverage", values: ["Sheer to light", "Sheer to light with moisturizer positioning"] },
      { label: "Finish", values: ["Skin-like or dewy", "Hydrated-looking or natural"] },
      { label: "Buyer mindset", values: ["Minimal makeup", "Hybrid routine"] },
      { label: "Shopping note", values: ["Check shade range", "Check SPF and moisturizer claims separately"] },
    ],
    relatedLinks: ["/makeup/luxury-foundation", "/best/best-skin-tint", "/beauty-university/shade-matching-guide"],
  },
  {
    slug: "concealer-vs-foundation",
    title: "Concealer vs Foundation",
    summary: "Choose between targeted coverage and all-over complexion polish.",
    verdict:
      "Concealer is better for targeted coverage and touch-ups, while foundation is better when the shopper wants a more unified complexion finish.",
    columns: ["Concealer", "Foundation"],
    rows: [
      { label: "Best role", values: ["Targeted coverage", "All-over complexion"] },
      { label: "Shade matching", values: ["Undereye or spot-specific", "Full-face match"] },
      { label: "Finish risk", values: ["Creasing or texture emphasis", "Oxidation or mismatch"] },
      { label: "Shopping note", values: ["Check undertone and use case", "Check coverage and lighting"] },
    ],
    relatedLinks: ["/makeup/luxury-concealer", "/makeup/luxury-foundation", "/beauty-university/shade-matching-guide"],
  },
  {
    slug: "mascara-vs-lash-primer",
    title: "Mascara vs Lash Primer",
    summary: "Compare a visible lash-finishing product with a prep layer for shoppers building an eye routine.",
    verdict:
      "Mascara is the essential visible finish, while lash primer is an optional prep layer for shoppers who want more structure before mascara.",
    columns: ["Mascara", "Lash primer"],
    rows: [
      { label: "Primary role", values: ["Color and lash finish", "Prep and structure"] },
      { label: "Routine need", values: ["Standalone product", "Layered before mascara"] },
      { label: "Buyer concern", values: ["Volume, length, or definition", "Grip and layering"] },
      { label: "Shopping note", values: ["Check brush and removal", "Check compatibility with mascara"] },
    ],
    relatedLinks: ["/makeup", "/best/best-mascara", "/sellers"],
  },
  {
    slug: "eyeliner-pencil-vs-liquid-liner",
    title: "Eyeliner Pencil vs Liquid Liner",
    summary: "Compare soft definition against sharper graphic eye looks.",
    verdict:
      "Pencil liner is usually easier for soft definition and smudged looks, while liquid liner is stronger for crisp wings and precise lines.",
    columns: ["Eyeliner pencil", "Liquid liner"],
    rows: [
      { label: "Best role", values: ["Soft definition", "Sharp precision"] },
      { label: "Skill level", values: ["Beginner-friendly", "More technique-sensitive"] },
      { label: "Finish", values: ["Smudged, satin, or matte", "Crisp, matte, or glossy"] },
      { label: "Shopping note", values: ["Check glide and wear language", "Check applicator and removal"] },
    ],
    relatedLinks: ["/makeup", "/best/best-eyeliner", "/beauty-university/shade-matching-guide"],
  },
  {
    ...
    rows: [
      { label: "Best role", values: ["Set and soften specific areas", "Finish the full makeup look"] },
      { label: "Texture", values: ["Loose or pressed powder", "Mist"] },
      { label: "Buyer concern", values: ["Shine, blur, and crease control", "Makeup meld and final feel"] },
      { label: "Shopping note", values: ["Check shade and flashback language", "Check finish and fragrance"] },
    ],
    relatedLinks: ["/makeup/setting-powder", "/best/best-setting-spray", "/makeup"],
  },
  {
    slug: "lipstick-vs-lip-liner",
    title: "Lipstick vs Lip Liner",
    summary: "Compare full lip color with shaping and definition before building a lip look.",
    verdict:
      "Lipstick is the main color step, while lip liner is best for definition, shaping, and helping the lip look feel more intentional.",
    columns: ["Lipstick", "Lip liner"],
    rows: [
      { label: "Primary role", values: ["Color and finish", "Definition and shape"] },
      { label: "Finish", values: ["Matte, satin, glossy, or balm-like", "Usually pencil or creamy matte"] },
      { label: "Best for", values: ["Complete lip look", "Polished edges or base color"] },
      { label: "Shopping note", values: ["Check shade and comfort", "Check undertone and glide"] },
    ],
    relatedLinks: ["/lip-care", "/best/best-lipstick", "/best/best-lip-liner"],
  },
  {
    slug: "lip-plumper-vs-lip-gloss",
    ...
    rows: [
      ...
      { label: "Comfort consideration", values: ["Tingling or warming may be present", "Usually less sensation-led"] },
      { label: "Buyer mindset", values: ["Curious about plumper positioning", "Wants shine and color"] },
      { label: "Shopping note", values: ["Read warnings and directions", "Check stickiness, tint, and fragrance"] },
    ],
    relatedLinks: ["/lip-care/lip-plumpers", "/lip-care/lip-oils", "/beauty-university/ingredients-to-watch-in-lip-plumpers"],
  },
  {
    slug: "lip-oil-vs-tinted-lip-balm",
    title: "Lip Oil vs Tinted Lip Balm",
    summary: "Compare cushiony shine with portable color and comfort.",
    verdict:
      "Lip oil usually wins for glossy cushion, while tinted lip balm is better for easy reapplication and everyday low-effort color.",
    columns: ["Lip oil", "Tinted lip balm"],
    rows: [
      { label: "Best role", values: ["Glossy comfort-shine", "Portable color comfort"] },
      { label: "Texture", values: ["Slick, cushiony, or plush", "Balm, stick, or squeeze format"] },
      { label: "Use case", values: ["Polished shine", "Daily carry"] },
      { label: "Shopping note", values: ["Check tint and fragrance", "Check SPF, shade, and finish"] },
    ],
    relatedLinks: ["/lip-care/lip-oils", "/lip-care/tinted-lip-balms", "/best/best-lip-oil"],
  },
  {
    slug: "shampoo-vs-cleansing-conditioner",
    title: "Shampoo vs Cleansing Conditioner",
    summary: "Compare a classic cleanse step with a gentler-feeling wash-day alternative.",
    verdict:
    ...
    relatedLinks: ["/hair-care/luxury-shampoo-conditioner", "/best/best-shampoo", "/beauty-university/hair-care-routine-map"],
  },
  {
    slug: "hair-mask-vs-conditioner",
    title: "Hair Mask vs Conditioner",
    summary: "Compare a routine staple with a richer occasional treatment step.",
    verdict:
      "Conditioner is the regular wash-day staple, while a hair mask is better for shoppers who want a richer occasional care step.",
    columns: ["Hair mask", "Conditioner"],
    rows: [
      { label: "Routine fit", values: ["Occasional richer step", "Regular wash-day step"] },
      { label: "Texture", values: ["Thicker cream or treatment", "Cream, lotion, or rinse-out formula"] },
      { label: "Buyer mindset", values: ["Upgrade or reset feel", "Everyday manageability"] },
      { label: "Shopping note", values: ["Check frequency and timing", "Check hair type and rinse feel"] },
    ],
    relatedLinks: ["/hair-care/hair-masks", "/hair-care/luxury-shampoo-conditioner", "/beauty-university/hair-care-routine-map"],
  },
  {
    slug: "hair-oil-vs-leave-in-conditioner",
    title: "Hair Oil vs Leave-In Conditioner",
    summary: "Compare finishing shine with leave-in softness and styling support.",
    verdict:
      "Hair oil is usually better for finishing shine and polish, while leave-in conditioner is stronger for lightweight conditioning and styling prep.",
    columns: ["Hair oil", "Leave-in conditioner"],
    rows: [
      { label: "Best role", values: ["Finish and shine", "Prep and softness"] },
      { label: "Texture", values: ["Oil or serum-like", "Spray, cream, or lotion"] },
      { label: "Use case", values: ["Ends, frizz look, polish", "Detangling and styling prep"] },
      { label: "Shopping note", values: ["Check weight and fragrance", "Check hair type and heat-tool context"] },
    ],
    relatedLinks: ["/hair-care", "/best/best-leave-in-conditioner", "/beauty-university/hair-care-routine-map"],
  },
  {
  ...
  {
    slug: "body-lotion-vs-body-oil",
    title: "Body Lotion vs Body Oil",
    summary: "Compare everyday body moisture with richer shine and layering texture.",
    verdict:
      "Body lotion is the more practical daily staple, while body oil is better for shoppers who want sheen, layering, or a more indulgent body-care finish.",
    columns: ["Body lotion", "Body oil"],
    rows: [
      { label: "Best role", values: ["Daily body moisture", "Sheen and layering"] },
      { label: "Texture", values: ["Cream or lotion", "Oil or dry oil"] },
      { label: "Use case", values: ["Everyday routine", "Post-shower polish or scent layering"] },
      { label: "Shopping note", values: ["Check fragrance and dry-down", "Check slip, transfer, and packaging"] },
    ],
    relatedLinks: ["/body-care/body-moisturizers", "/body-care", "/beauty-university/body-care-layering-guide"],
  },
  {
    ...
    relatedLinks: ["/body-care/body-exfoliants", "/beauty-tools", "/beauty-university/body-care-layering-guide"],
  },
  {
    ...
    rows: [
      ...
      { label: "Tools needed", values: ["Usually minimal", "May require lamp or specific remover"] },
      { label: "Flexibility", values: ["Easy shade switching", "More commitment"] },
      { label: "Shopping note", values: ["Check dry time and finish", "Check lamp setup and removal directions"] },
    ],
    relatedLinks: ["/nail-care/luxury-nail-polish", "/nail-care/manicure-tools", "/beauty-university/nail-care-tool-checklist"],
  },
  {
    slug: "cuticle-oil-vs-hand-cream",
    title: "Cuticle Oil vs Hand Cream",
    summary: "Compare targeted nail-area care with broader hand comfort.",
    verdict:
      "Cuticle oil is the targeted nail-area step, while hand cream is the broader comfort and daily carry product.",
    columns: ["Cuticle oil", "Hand cream"],
    rows: [
      { label: "Best role", values: ["Targeted cuticle area", "Hands and broader skin feel"] },
      { label: "Texture", values: ["Oil, serum, or pen", "Cream, balm, or lotion"] },
      { label: "Use case", values: ["Manicure finishing", "Daily hand routine"] },
      { label: "Shopping note", values: ["Check applicator and fragrance", "Check finish and absorption"] },
    ],
    relatedLinks: ["/nail-care/cuticle-care", "/body-care/luxury-hand-care", "/beauty-university/nail-care-tool-checklist"],
  },
  {
    slug: "makeup-brushes-vs-beauty-sponge",
    title: "Makeup Brushes vs Beauty Sponge",
    summary: "Compare tool control, blending style, and finish for complexion and color products.",
    verdict:
      "Brushes usually win for control, powder, and structure, while a sponge is better for soft blending and sheerer complexion application.",
    columns: ["Makeup brushes", "Beauty sponge"],
    rows: [
      { label: "Best role", values: ["Control and structure", "Soft blending"] },
      { label: "Product fit", values: ["Powder, cream, and complexion", "Liquid and cream complexion"] },
      { label: "Maintenance", values: ["Wash multiple brush types", "Replace or wash sponge often"] },
      { label: "Shopping note", values: ["Check brush shape and fibers", "Check texture and cleaning routine"] },
    ],
    relatedLinks: ["/beauty-tools/makeup-brushes", "/makeup/luxury-foundation", "/beauty-university/beauty-routine-order-chart"],
  },
  {
    slug: "facial-roller-vs-gua-sha",
    title: "Facial Roller vs Gua Sha",
    summary: "Compare two facial tool formats by technique, routine feel, and buyer expectations.",
    verdict:
      "A facial roller is usually simpler for a cooling massage ritual, while gua sha is more technique-led and requires careful pressure and direction.",
    columns: ["Facial roller", "Gua sha"],
    rows: [
      { label: "Best role", values: ["Simple massage ritual", "Technique-led tool ritual"] },
      { label: "Ease of use", values: ["More beginner-friendly", "More technique-sensitive"] },
      { label: "Routine pairing", values: ["Serum or moisturizer glide", "Oil or slip-focused product"] },
      { label: "Shopping note", values: ["Check material and cleaning", "Avoid pressure claims and follow safe-use guidance"] },
    ],
    relatedLinks: ["/beauty-tools/facial-tools", "/beauty-university/beauty-routine-order-chart", "/beauty-claims-guide"],
  },
  {
    ...
    rows: [
      { label: "Best role", values: ["Drying flexibility", "Simplified styling"] },
      { label: "Technique", values: ["Separate brush often needed", "Brush and airflow combined"] },
      { label: "Buyer mindset", values: ["Control and speed", "At-home blowout convenience"] },
      { label: "Shopping note", values: ["Check attachments and heat settings", "Check barrel size and hair length fit"] },
    ],
  ...
  },
  {
    ...
    rows: [
      { label: "Best role", values: ["Face-framing accessory", "Outfit focal point"] },
      { label: "Beauty pairing", values: ["Works with lip, blush, and hair looks", "Works with fragrance and occasion styling"] },
      { label: "Fit concern", values: ["Weight and closure", "Length and neckline"] },
      { label: "Shopping note", values: ["Check material and dimensions", "Check clasp, chain length, and return policy"] },
    ],
    relatedLinks: ["/artificial-jewelry/fashion-earrings", "/artificial-jewelry/fashion-necklaces", "/beauty-university/artificial-jewelry-styling-guide"],
  },
  {
    slug: "jewelry-gift-set-vs-beauty-gift-set",
    title: "Jewelry Gift Set vs Beauty Gift Set",
    summary: "Compare accessory-led gifts with beauty product sets when shopper preferences are uncertain.",
    verdict:
      "Jewelry gift sets can be safer when shade or scent preferences are unknown, while beauty gift sets work better when the recipient already likes the brand or category.",
    columns: ["Jewelry gift set", "Beauty gift set"],
    rows: [
      { label: "Best role", values: ["Accessory-led occasion gift", "Product-led beauty gift"] },
      { label: "Preference risk", values: ["Material and style risk", "Shade, scent, and routine risk"] },
      { label: "Gift appeal", values: ["Wearable finishing touch", "Discovery or replenishment"] },
      { label: "Shopping note", values: ["Check materials and closures", "Check product sizes and return policy"] },
    ],
  ...
  },
  {
    ...
    summary: "Compare two exfoliation approaches with careful sensitivity and use-direction context.",
    verdict:
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Routine fit", values: ["Classic rinse-clean feel", "Everyday flexible cleanse"] },
  ...
  },
  {
    ...
    summary: "Compare two SPF formula styles by finish, feel, and makeup compatibility.",
    verdict:
  ...
  },
  {
    ...
    summary: "Compare scalp-focused brush terminology by routine fit, bristle feel, and shower use.",
    verdict:
  ...
  },
  {
    ...
    summary: "Compare press-on nail attachment options by hold, removal, and commitment.",
    verdict:
  ...
  },
  {
    ...
    summary: "Compare two light complexion options by coverage, skin-care feel, and daily routine fit.",
    verdict:
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Shopping note", values: ["Check texture and fragrance intensity", "Check set pairing and retailer clarity"] },
    ],
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Routine fit", values: ["Cream step with active positioning", "Targeted serum step"] },
  ...
  },
  {
    ...
    summary: "Compare two vitamin-A-positioned serums without overstating outcomes.",
    verdict:
  ...
  },
  {
    ...
    summary: "Compare peptide-positioned creams and serums by texture and routine fit.",
    verdict:
  ...
  },
  {
    ...
    summary: "Compare richer ceramide-positioned creams with lighter barrier-support serums.",
    verdict:
  ...
  },
  {
    ...
    summary: "Compare moisturizers with SPF against dedicated face sunscreen shopping.",
    verdict:
  ...
  },
  {
    ...
    rows: [
      { label: "Routine fit", values: ["Evening moisturizer", "Overnight ritual layer"] },
  ...
  },
  {
    ...
    summary: "Compare two salon-style nail color options by finish, removal, and at-home buying considerations.",
    verdict:
  ...
  },
  {
    ...
    summary: "Compare two common skin-care ingredient stories by routine fit, texture, and product positioning.",
    verdict:
  ...
  },
  {
    ...
    summary: "Compare two tone-and-texture ingredient stories without overstating skin outcomes.",
    verdict:
  ...
  },
  {
    ...
    summary: "Compare two oil-like beauty ingredients by texture, product format, and routine fit.",
    verdict:
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Shopping note", values: ["Read full label and retailer details", "Do not assume fragrance-free"] },
    ],
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Buyer concern", values: ["Stock and retailer details", "Retailer identity and listing quality"] },
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Shopping note", values: ["Check curation and brand authorization", "Check retailer details and delivery"] },
    ],
  ...
  },
  {
    ...
    summary: "A practical look at premium skin-care shopping next to accessible drugstore routine building.",
    verdict:
    ...
    rows: [
      ...
      { label: "Shopping note", values: ["Compare ingredient story and retailer clarity", "Do not assume lower price means lower usefulness"] },
    ],
  ...
  },
  {
    ...
    summary: "Compare two popular skin-care discovery styles by routine style and shopping expectations.",
    verdict:
    ...
    rows: [
      ...
      { label: "Buyer concern", values: ["Retailer clarity and ingredient familiarity", "Availability and product instructions"] },
  ...
  },
  {
    ...
    summary: "Compare Japanese and Korean beauty shopping styles by routine style, textures, and category strengths.",
    verdict:
    ...
    rows: [
      ...
      { label: "Buyer concern", values: ["Retailer clarity and directions", "Retailer clarity and ingredient translations"] },
      { label: "Shopping note", values: ["Check authorized retailer details", "Check product directions and authenticity cues"] },
    ],
    relatedLinks: ["/skin-care", "/beauty-routines", "/beauty-university/beauty-routine-order-chart"],
  },
  {
    ...
    rows: [
      ...
      { label: "Shopping note", values: ["Check hair type notes and retailer clarity", "Compare directions and size value"] },
    ],
  ...
  },
  {
    ...
    summary: "A practical look at premium lipstick shopping next to accessible lip color discovery.",
    verdict:
    ...
    rows: [
      ...
      { label: "Shopping note", values: ["Check swatches and retailer clarity", "Check reviews and undertone notes"] },
    ],
  ...
  },
  {
    ...
    rows: [
      ...
      { label: "Buyer concern", values: ["Sales pressure and stock limits", "Shade uncertainty and retailer clarity"] },
      { label: "Strongest categories", values: ["Foundation, fragrance, luxury gifts", "Replenishment, tools, sets, research"] },
      { label: "Shopping note", values: ["Use service for fit questions", "Check return policy and retailer details"] },
    ],
...
export const beautyCalculators = [
  {
    ...
    summary: "Map skin concern, makeup style, budget, and brand preference into better shopping choices.",
  },
  {
    slug: "gift-finder",
    title: "Beauty Gift Finder",
    summary: "Narrow luxury beauty gifts by recipient, price tier, category, and retailer clarity.",
  },
];
...
export const beautyBrands = [
  ...
  },
  {
    slug: "skinceuticals",
    name: "SkinCeuticals",
    description: "SkinCeuticals is a strong starting point for premium serum shoppers comparing ingredient-led products with careful context.",
  },
  {
    slug: "cerave",
    name: "CeraVe",
  ...
  },
  {
    slug: "olaplex",
    name: "Olaplex",
    description: "Olaplex is useful for hair-care shoppers comparing treatment-positioned products, masks, stylers, and retailer clarity.",
  },
  {
    slug: "jo-malone",
...
export const beautySellers = [
  ...
  },
  {
    slug: "iherb",
    name: "iHerb",
    description: "iHerb is useful for beauty-adjacent shoppers comparing supplements, skin care, body care, oils, and wellness-positioned beauty staples.",
    bestFor: ["Wellness beauty", "Body care", "Supplement-adjacent shopping"],
    trustSignal: "Good fit when shoppers want beauty products beside wellness, supplement, and personal-care categories.",
    affiliateUrl: "https://www.iherb.com/c/beauty",
  },
  {
    slug: "dermstore",
    name: "Dermstore",
    description: "Dermstore fits skin-care shoppers comparing premium serums, sunscreens, moisturizers, and treatment-positioned beauty products.",
    bestFor: ["Premium skin care", "SPF", "Ingredient-led routines"],
    trustSignal: "Strong specialty option for shoppers who want skin-care depth and product education before continuing.",
    affiliateUrl: "https://www.dermstore.com/",
  },
  {
    slug: "bluemercury",
    name: "Bluemercury",
  ...
  },
  {
    slug: "macys",
    name: "Macy's",
    description: "Macy's fits beauty shoppers comparing department-store fragrance, makeup, skin care, gift sets, and seasonal beauty promotions.",
    bestFor: ["Department-store beauty", "Fragrance gifts", "Seasonal sets"],
    trustSignal: "Useful when gifting, brand variety, and familiar department-store checkout matter.",
    affiliateUrl: "https://www.macys.com/shop/makeup-and-perfume",
  },
  {
    slug: "bloomingdales",
    name: "Bloomingdale's",
  ...
  },
  {
    ...
    description: "Saks Fifth Avenue is useful for luxury beauty shoppers comparing designer fragrance, prestige skin care, makeup, and giftable beauty.",
    bestFor: ["Luxury beauty", "Designer fragrance", "Premium gifts"],
    trustSignal: "Good fit when brand prestige, packaging, and department-store trust matter.",
    affiliateUrl: "https://www.saksfifthavenue.com/c/beauty",
  },
  {
    slug: "target",
    name: "Target",
  ...
  },
  {
    slug: "walmart",
    name: "Walmart",
    description: "Walmart is useful for broad beauty comparison, accessible product categories, routine staples, and price-conscious replenishment.",
    bestFor: ["Budget beauty", "Broad selection", "Everyday staples"],
    trustSignal: "Best used with clear retailer checks, return-policy context, and product-specific comparison before continuing.",
    affiliateUrl: "https://www.walmart.com/cp/beauty/1085666",
  },
  {
    slug: "violet-grey",
    name: "Violet Grey",
    description: "Violet Grey fits luxury beauty shoppers comparing editorially curated skin care, makeup, fragrance, and prestige beauty gifts.",
    bestFor: ["Editorial curation", "Luxury beauty", "Premium gifts"],
    trustSignal: "Good fit when a shopper wants a more curated luxury-beauty shopping experience.",
    affiliateUrl: "https://www.violetgrey.com/",
  },
  {
    slug: "credo-beauty",
    name: "Credo Beauty",
    description: "Credo Beauty is useful for shoppers comparing ingredient-conscious beauty retail paths while still checking product claims carefully.",
    bestFor: ["Ingredient-conscious shopping", "Skin care", "Makeup"],
    trustSignal: "Useful when shoppers want visible ingredient standards, but LipFlower should still avoid unsupported safety or efficacy claims.",
    affiliateUrl: "https://credobeauty.com/",
  },
];

export const beautyBrandCategories = [
  { brandSlug: "dior", categorySlug: "makeup", title: "Dior Makeup", summary: "Explore Dior complexion, lip, and color products before selecting a seller." },
  { brandSlug: "chanel", categorySlug: "fragrance", title: "CHANEL Fragrance", summary: "Explore CHANEL fragrance choices, gift sets, and signature scents." },
  { brandSlug: "la-mer", categorySlug: "skin-care", title: "La Mer Skin Care", summary: "A guide to La Mer creams, serums, and ultra-premium skin care routines." },
  { brandSlug: "tom-ford-beauty", categorySlug: "lip-care", title: "Tom Ford Lip Color", summary: "A guide to premium lip color and luxury makeup retailers." },
  { brandSlug: "charlotte-tilbury", categorySlug: "makeup", title: "Charlotte Tilbury Makeup", summary: "Explore Charlotte Tilbury complexion, glow, cheek, and lip products before choosing a retailer." },
  { brandSlug: "rare-beauty", categorySlug: "makeup", title: "Rare Beauty Makeup", summary: "Shop Rare Beauty cheek, complexion, and lip products with shade and seller context." },
  { brandSlug: "fenty-beauty", categorySlug: "makeup", title: "Fenty Beauty Makeup", summary: "Shop Fenty Beauty complexion, lip, and cheek picks with shade and undertone context." },
  { brandSlug: "nars", categorySlug: "makeup", title: "NARS Makeup", summary: "Explore NARS complexion, blush, bronzer, and lip products by finish and routine fit." },
  { brandSlug: "armani-beauty", categorySlug: "makeup", title: "Armani Beauty Makeup", summary: "Explore Armani complexion, lip, and fragrance-adjacent beauty picks." },
  { brandSlug: "tatcha", categorySlug: "skin-care", title: "Tatcha Skin Care", summary: "A guide to Tatcha cleansers, moisturizers, masks, and ritual-led skin care." },
  { brandSlug: "drunk-elephant", categorySlug: "skin-care", title: "Drunk Elephant Skin Care", summary: "A guide to Drunk Elephant serums, moisturizers, and routine-building product paths." },
  { brandSlug: "skinceuticals", categorySlug: "skin-care", title: "SkinCeuticals Serums", summary: "A SkinCeuticals serum guide with ingredient-led but careful buying context." },
  { brandSlug: "cerave", categorySlug: "skin-care", title: "CeraVe Skin Care", summary: "A guide to CeraVe cleansers, moisturizers, SPF, and practical routine staples." },
  { brandSlug: "la-roche-posay", categorySlug: "skin-care", title: "La Roche-Posay Skin Care", summary: "A guide to La Roche-Posay sunscreen, cleanser, moisturizer, and sensitive-routine picks." },
  { brandSlug: "laneige", categorySlug: "lip-care", title: "Laneige Lip Care", summary: "Explore Laneige lip masks, lip balms, and hydrating-positioned beauty products." },
  { brandSlug: "summer-fridays", categorySlug: "lip-care", title: "Summer Fridays Lip Care", summary: "Explore Summer Fridays lip butter balms, skin tints, and easy gifts." },
  { brandSlug: "sol-de-janeiro", categorySlug: "body-care", title: "Sol de Janeiro Body Care", summary: "Explore Sol de Janeiro body creams, fragrance mists, and giftable body-care paths." },
  { brandSlug: "oribe", categorySlug: "hair-care", title: "Oribe Hair Care", summary: "A guide to Oribe shampoo, conditioner, styling, and premium hair-care retailers." },
  { brandSlug: "kerastase", categorySlug: "hair-care", title: "Kerastase Hair Care", summary: "A guide to Kerastase cleansing, conditioning, masks, and routine-specific hair-care paths." },
  { brandSlug: "olaplex", categorySlug: "hair-care", title: "Olaplex Hair Care", summary: "A guide to Olaplex treatment-positioned products, masks, and styling support picks." },
  { brandSlug: "jo-malone", categorySlug: "fragrance", title: "Jo Malone Fragrance", summary: "Explore Jo Malone discovery sets, scent families, gifting, and fragrance retailers." },
  { brandSlug: "maison-margiela", categorySlug: "fragrance", title: "Maison Margiela Replica Fragrance", summary: "Explore Replica fragrance stories, discovery sets, and giftable scents." },
  { brandSlug: "essie", categorySlug: "nail-care", title: "Essie Nail Care", summary: "Explore Essie polish color families, manicure staples, and retailers." },
  { brandSlug: "dyson-beauty", categorySlug: "beauty-tools", title: "Dyson Beauty Tools", summary: "A guide to Dyson hair styling tools by use case, gifting context, and seller policy." },
  { brandSlug: "kate-spade-jewelry", categorySlug: "artificial-jewelry", title: "Kate Spade Fashion Jewelry", summary: "Explore Kate Spade earrings, necklaces, and giftable fashion-jewelry accessories." },
];
...
export const beautyCategoryPages = [
  {
    ...
    intro:
      "The Beauty hub is the broad starting point for shoppers who want polished, careful beauty research before comparing retailers, categories, routines, and product formats.",
    eyebrow: "Beauty",
    sections: [
      {
        title: "Core beauty pillars",
        links: [
          { href: "/skin-care", label: "Skin care", description: "Explore premium serums, moisturizers, SPF, cleansers, and routine-led skin care." },
          { href: "/hair-care", label: "Hair care", description: "Explore salon-inspired shampoos, masks, scalp care, and styling support." },
          { href: "/makeup", label: "Makeup", description: "Shop luxury complexion, cheek, lip, eye, and finishing products with more context." },
          { href: "/fragrance", label: "Fragrance", description: "Browse discovery sets, signature scents, gifts, and luxury fragrance houses." },
          { href: "/body-care", label: "Body care", description: "Explore body moisturizers, exfoliants, hand care, and fragrance layering." },
          { href: "/beauty-tools", label: "Beauty tools", description: "Explore brushes, facial tools, manicure tools, and hair styling tools." },
          { href: "/artificial-jewelry", label: "Artificial jewelry", description: "Browse fashion earrings, necklaces, bracelets, and giftable jewelry sets." },
        ],
      },
      {
        title: "Authority and comparison paths",
        links: [
          { href: "/beauty-university", label: "Beauty University", description: "Read careful guides before choosing ingredients, routines, or products." },
          { href: "/compare", label: "Compare products and routines", description: "Use head-to-head pages before continuing to retailers." },
  ...
  },
  {
    ...
    description: "Explore premium serums, creams, cleansers, eye treatments, SPF, and skin-care routines.",
    intro:
      "Luxury skin care shoppers need more than a brand logo. This guide keeps concern, texture, routine fit, retailer confidence, and giftability visible.",
    eyebrow: "Skin care",
    sections: [
      {
        ...
        links: [
          ...
          { href: "/brands/la-mer", label: "La Mer", description: "Explore ultra-premium skin care before choosing a seller." },
          { href: "/compare/luxury-serum-vs-moisturizer", label: "Serum vs moisturizer", description: "Use the comparison when routine fit is still unclear." },
        ],
      },
    ],
  },
  {
    slug: "makeup",
    title: "Luxury Makeup",
    description: "Explore prestige foundation, lipstick, eye makeup, blush, bronzer, and finishing products.",
    intro:
      "Luxury makeup is about finish, shade, occasion, packaging, and retailer clarity, not just the most prominent product tile.",
    eyebrow: "Makeup",
    sections: [
      {
        title: "Best next guides",
        links: [
          { href: "/makeup/luxury-foundation", label: "Luxury foundation", description: "Choose complexion products by finish, coverage, and shade path." },
          { href: "/makeup/luxury-concealer", label: "Luxury concealer", description: "Find high-end concealer by coverage, finish, and undertone." },
          { href: "/makeup/cream-blush", label: "Cream blush", description: "Shop fresh color, pigment, texture, and retailer clarity." },
          { href: "/makeup/setting-powder", label: "Setting powder", description: "Check finish, soft-focus positioning, tone support, and event makeup fit." },
          { href: "/brands/dior", label: "Dior Beauty", description: "Move into designer makeup and lip color research." },
          { href: "/compare/luxury-foundation-vs-skin-tint", label: "Foundation vs skin tint", description: "Choose the right complexion lane before continuing." },
        ],
      },
    ],
  },
  {
    ...
    description: "Explore premium lip masks, balms, oils, plumpers, liners, gloss, and lipstick routines.",
    intro:
    ...
    sections: [
      {
        title: "Best next guides",
        links: [
          { href: "/lip-care/lip-masks", label: "Lip masks", description: "See how overnight and balm-mask treatment formats differ." },
          { href: "/lip-care/lip-oils", label: "Lip oils", description: "Choose glossy comfort, tint, applicator, and fragrance preferences." },
          { href: "/lip-care/tinted-lip-balms", label: "Tinted lip balms", description: "Find low-effort color, comfort, and daily-carry appeal." },
          { href: "/lip-care/lip-plumpers", label: "Lip plumpers", description: "Understand sensation, shine, and realistic makeup expectations." },
  ...
  },
  {
    ...
    description: "Explore prestige fragrance, discovery sets, designer scents, and premium gifting paths.",
    intro:
      "Fragrance shoppers need retailer clarity, format details, bottle size, occasion, and gift presentation before committing to a luxury scent.",
    eyebrow: "Fragrance",
    sections: [
      {
        title: "Best next guides",
        links: [
          { href: "/fragrance/fragrance-discovery-sets", label: "Fragrance discovery sets", description: "Explore sample sets, scent families, and lower-risk luxury fragrance paths." },
          { href: "/fragrance/luxury-perfume-gifts", label: "Luxury perfume gifts", description: "Choose by bottle size, presentation, scent confidence, and seller flexibility." },
          ...
          { href: "/brands/chanel", label: "CHANEL Beauty", description: "Explore classic luxury fragrance choices." },
  ...
  },
  {
    ...
    description: "Explore premium shampoos, conditioners, masks, scalp care, stylers, and heat tools.",
    intro:
      "Luxury hair care decisions work best when shoppers compare hair type, routine step, fragrance, treatment intensity, and retailer clarity before continuing.",
    eyebrow: "Hair care",
    sections: [
      {
        title: "Best next guides",
        links: [
          { href: "/hair-care/luxury-shampoo-conditioner", label: "Luxury shampoo and conditioner", description: "Choose premium wash-day staples by hair type, fragrance, and finish." },
          { href: "/hair-care/hair-masks", label: "Hair masks", description: "Find rinse-out and treatment-style masks by texture and routine fit." },
          { href: "/hair-care/scalp-care", label: "Scalp care", description: "Explore scalp-focused formats with careful guidance." },
          { href: "/beauty-university", label: "Routine guides", description: "Use education guides before building a premium hair routine." },
          { href: "/sellers/sephora", label: "Sephora", description: "Browse salon and prestige beauty hair-care retailers." },
          { href: "/luxury-beauty", label: "Luxury beauty edit", description: "Return to a broader prestige shopping guide." },
        ],
      },
    ],
  },
  {
    ...
    description: "Explore body moisturizers, exfoliants, SPF, hand care, body fragrance, and bath products.",
    intro:
    ...
    sections: [
      {
        title: "Best next guides",
        links: [
          { href: "/body-care/body-moisturizers", label: "Body moisturizers", description: "Choose premium body creams and lotions by texture, scent, and routine fit." },
          { href: "/body-care/body-exfoliants", label: "Body exfoliants", description: "Explore scrubs and exfoliating body products with use-direction context." },
          { href: "/body-care/luxury-hand-care", label: "Luxury hand care", description: "Find hand creams and portable body-care gifts by finish and fragrance." },
  ...
  },
  {
    ...
    description: "Explore nail polish, treatments, cuticle care, manicure tools, and premium hand-care systems.",
    intro:
    ...
    sections: [
      {
        title: "Best next guides",
        links: [
          { href: "/nail-care/luxury-nail-polish", label: "Luxury nail polish", description: "Browse premium shades, finishes, and retailer clarity." },
          { href: "/nail-care/cuticle-care", label: "Cuticle care", description: "Explore oils, creams, and hand-care pairings with careful language." },
          { href: "/nail-care/manicure-tools", label: "Manicure tools", description: "Check material, care, and handling before upgrading at-home tools." },
          { href: "/beauty-tools", label: "Beauty tools", description: "Explore tools that support polished at-home routines." },
  ...
  },
  {
    ...
    description: "Explore premium brushes, facial tools, hair tools, organizers, and routine accessories.",
    intro:
      "Beauty tools should be compared by material, ergonomics, routine fit, care instructions, and retailer clarity rather than trend language alone.",
    eyebrow: "Beauty tools",
    sections: [
      {
        title: "Best next guides",
        links: [
          { href: "/beauty-tools/makeup-brushes", label: "Makeup brushes", description: "Choose by shape, material, application role, and cleaning needs." },
          { href: "/beauty-tools/facial-tools", label: "Facial tools", description: "Check routine fit, materials, and care instructions without unsupported claims." },
          { href: "/beauty-tools/hair-styling-tools", label: "Hair styling tools", description: "Review heat settings, attachments, warranty context, and retailer clarity." },
          { href: "/makeup", label: "Makeup", description: "Pair brushes and applicators with complexion and color decisions." },
          { href: "/hair-care", label: "Hair care", description: "Explore tools that support salon-style hair routines." },
  ...
  },
  {
    ...
    description: "Explore artificial jewelry, fashion earrings, necklaces, bracelets, gift sets, and beauty-adjacent accessories.",
    intro:
      "Artificial jewelry belongs in LipFlower as a styling and gifting layer: it helps shoppers complete beauty looks, coordinate occasion outfits, and compare retailer details without confusing accessories with cosmetic claims.",
    eyebrow: "Artificial jewelry",
    sections: [
      {
        title: "Best next guides",
        links: [
          { href: "/artificial-jewelry/fashion-earrings", label: "Fashion earrings", description: "Choose statement and everyday earrings by tone, closure, weight, and occasion." },
          { href: "/artificial-jewelry/fashion-necklaces", label: "Fashion necklaces", description: "Browse chains, pendants, layering pieces, and giftable necklaces." },
          { href: "/artificial-jewelry/fashion-bracelets", label: "Fashion bracelets", description: "Find stacking styles, fit, finish, clasp style, and retailer clarity." },
          { href: "/artificial-jewelry/jewelry-gift-sets", label: "Jewelry gift sets", description: "Review artificial jewelry sets by presentation, versatility, and return-friendly retailers." },
  ...
  },
  {
    ...
    description: "Explore natural-positioned beauty products with careful ingredient, seller, and claim context.",
    intro:
    ...
    sections: [
      {
        title: "Best next guides",
        links: [
          { href: "/skin-care", label: "Skin care", description: "Explore ingredient-led skin-care routines." },
    ...
    sections: [
      {
        ...
        links: [
          ...
          { href: "/fragrance", label: "Fragrance", description: "Explore scent and gifting paths." },
        ],
      },
    ],
  },
...
export const beautyUniversityTopics = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "Luxury complexion products are fit-sensitive purchases. LipFlower favors retailers where return rules, shade exchange options, and product-condition expectations are easy to understand before continuing.",
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "A lower price can be attractive, but it should not replace retailer clarity. LipFlower keeps price, retailer details, and product positioning together so shoppers can make a more careful decision.",
      },
    ],
    ...
    faqs: [
      {
        ...
        answer:
          "No. LipFlower provides shopping guidance and links to retailer pages, but shoppers should verify current seller details, policies, and listing information on the destination site.",
      },
      {
        question: "Why include retailer guidance on shopping pages?",
        answer:
  ...
  },
  {
    ...
    description: "Understand how comfort, dryness, texture, and moisturizer choice fit into a careful skin-care routine.",
    intro:
  ...
  },
  {
    ...
    intro:
      "Ingredient-led shopping works best when the shopper separates visible product claims, concentration context, sensitivity history, and retailer clarity.",
    sections: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "No. Ingredient explanations must stay general, careful, and grounded in visible product positioning or broadly cautious shopping education.",
      },
      {
  ...
  },
  {
    ...
    description: "Build a polished makeup-prep routine across moisturizer, SPF, primer, complexion, and setting products.",
    intro:
  ...
  },
  {
    ...
    description: "Compare discovery sets, bottle sizes, scent families, and retailer return details before buying fragrance as a gift.",
    intro:
    ...
    sections: [
      {
        ...
        body:
          "Fragrance is personal, so a discovery set or travel spray can be a safer gift choice than a full-size bottle when the recipient's scent preferences are unknown.",
      },
      {
  ...
  },
  {
    ...
    description: "A careful shopper-first cheat sheet for comparing ingredient-led products without inventing benefits or assured outcomes.",
    intro:
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "It gives ingredient and routine guides a central educational reference so shoppers can move naturally between related decisions.",
      },
    ],
  ...
  },
  {
    ...
    intro:
      "Artificial jewelry belongs on LipFlower when it supports the final beauty look: occasion styling, gifting, editorial presentation, and retailer clarity.",
    sections: [
      {
        title: "Style jewelry around the beauty finish",
        body:
          "Glossy makeup, soft matte skin, bold lipstick, and fragrance gifting all create different accessory moments. The useful shopping guide connects jewelry format to the complete beauty look.",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "A beautiful gift still needs a practical retailer. LipFlower keeps return clarity and retailer details close to gift recommendations.",
      },
    ],
  ...
  },
  {
    ...
    description: "A reference map for comparing shampoo, conditioner, scalp care, masks, stylers, tools, and finishing products by routine fit.",
    intro:
    ...
    sections: [
      {
        title: "Start with the product's routine fit",
        body:
  ...
  },
  {
    ...
    intro:
      "Nail-care shopping crosses beauty, tools, and gifting, so this checklist keeps tool quality, routine fit, hygiene expectations, and retailer clarity visible.",
    sections: [
      {
    ...
    faqs: [
      {
        ...
        answer:
          "Layering guidance helps connect body moisturizers, exfoliants, SPF, hand care, and fragrance guides without repeating the same advice.",
      },
      {
  ...
  },
  {
    ...
    description: "A scent-family reference for comparing floral, fresh, warm, woody, gourmand, citrus, and discovery-set fragrances.",
    intro:
    ...
    sections: [
      {
        ...
        body:
          "Floral, fresh, woody, citrus, warm, amber, and gourmand labels can help shoppers narrow the field before comparing bottle size, discovery sets, and retailer clarity.",
      },
      {
        title: "Discovery sets are useful comparison bridges",
        body:
          "A discovery set can connect fragrance education to shopping guides because it lets shoppers sample across scent families before choosing a full bottle.",
      },
    ],
